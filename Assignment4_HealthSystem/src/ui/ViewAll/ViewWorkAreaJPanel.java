 ...
 * @author  Rushabh
 */
public class ViewWorkAreaJPanel extends javax.swing.JPanel {
    JPanel mainWorkArea;
    CommunityDirectory supplierDirectory;
    EncounterHistory encounterHistory;
    
    /** Creates new form AdminWorkAreaJPanel */
    public ViewWorkAreaJPanel(JPanel mainWorkArea, CommunityDirectory supplierDirectory,EncounterHistory encounterHistory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        splitPane.setBackground(new java.awt.Color(185, 212, 232));
        splitPane.setDividerLocation(50);
        splitPane.setOrientation(javax.swing.JSplitPane.VERTICAL_SPLIT);

        menuBar.setBackground(new java.awt.Color(185, 212, 232));

        btnManageSuppliers.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        btnManageSuppliers.setForeground(new java.awt.Color(0, 51, 102));
        btnManageSuppliers.setText("View");
    ...
    private void btnManageSuppliersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageSuppliersActionPerformed
        ...
        ViewAll panel=new ViewAll(workArea,supplierDirectory,encounterHistory);
        workArea.add("EncounterView",panel);
